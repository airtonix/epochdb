...
angular.module( 'route-segment', [] )

    .provider( '$routeSegment', ['$routeProvider',
...
angular.module( 'view-segment', [ 'route-segment' ] )

    .directive( 'appViewSegment', ['$route', '$compile', '$controller', '$routeParams', '$routeSegment', '$q', '$injector',
